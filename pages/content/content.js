...
Page({
  ...
  data: {
    ...
    teachers: [
      {
        courseids: [1, 2],
        imgurl: '/res/img/teachers/liuhaiming.jpg',
        headname: '校长',
        name: '刘海明',
      ...
      {
        courseids: [1, 2],
        imgurl: '/res/img/teachers/wangxianyun.jpg',
        headname: '教师',
        name: '王鲜云',
      ...
      {
        courseids: [1, 2],
        imgurl: '/res/img/teachers/haoshanyi.jpg',
        headname: '教师',
        name: '郝珊艺',
      ...
      {
        courseids: [1, 2],
        imgurl: '/res/img/teachers/zhangxiong.jpg',
        headname: '教师',
        name: '张雄',
      ...
      {
        courseids: [1, 2],
        imgurl: '/res/img/teachers/litiantian.jpg',
        headname: '教师',
        name: '李甜甜',
      ...
      {
        courseids: [1, 2],
        imgurl: '/res/img/teachers/guoyubo.jpg',
        headname: '教师',
        name: '郭宇擘',
      ...
      {
        courseids: [1, 2],
        imgurl: '/res/img/teachers/wangjing.jpg',
        headname: '教师',
        name: '王静',
    ...
    videos: [
      {
        index: 1,
        videourl: '/res/courses/course01/video.mp4'
      }
    ]
  },
  ...
  onLoad: function (options) {
    ...
    var obj = this.data.teachers.findAll((n) => n.courseids.contains(index))
    this.setData({
      obj:obj
    })
  },
